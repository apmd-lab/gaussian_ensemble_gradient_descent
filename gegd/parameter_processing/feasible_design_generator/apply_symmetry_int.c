...
// ------------------ Helper: D1 ------------------
void compute_D1_int(const int* x, int* out, int N_x, int N_y) {
    int half = (N_x + 1) / 2;
...
// ------------------ Helper: D2 ------------------
void compute_D2_int(const int* x, int* out, int N_x, int N_y) {
    int half_x = (N_x + 1) / 2;
    int half_y = (N_y + 1) / 2;
...
// ------------------ Helper: D4 ------------------
void compute_D4_int(const int* x, int* out, int N) {
    int half = (N + 1) / 2;
