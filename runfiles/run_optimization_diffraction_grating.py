...
t_low_fidelity = 0.17 #0.17 0.31 # low-fidelity simulation time in seconds
t_high_fidelity = 5.66 # high-fidelity simulation time in seconds
...
suffix = 'diffraction_grating_Ndim' + str(Nx) + 'x' + str(Ny) + '_D' + str(symmetry) + '_upsample' + str(upsample_ratio) + '_sigma' + str(sigma_ensemble_max) + '_coeffExp' + str(coeff_exp) + '_brush' + str(brush_size) + '_try' + str(n_seed+1)
