...
upsampling_ratio_fdtd = np.array([1/2,1,2,3,4,5,6,7,8])
...
#        assert False
        ...
        np.savez(directory[:-15] + "/results/mode_converter_convergence_test_Nx" + str(Nx) + "_Ny" + str(Ny) + "_brush" + str(brush_size),
            cost_all=cost_all,
