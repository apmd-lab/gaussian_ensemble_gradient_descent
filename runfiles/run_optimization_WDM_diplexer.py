...
#--------------------------------------------------------------------------
import FDTD_functions.WDM_diplexer_ceviche as objfun

lam_tgt = np.array([1.53, 1.55])

design_dim = np.array([0.75, 1.5])
waveguide_width = 0.5
...
waveguide_bottom_output1 = int(center_y + waveguide_width_npix - waveguide_halfwidth_npix)
waveguide_top_output1 = int(waveguide_bottom_output1 + waveguide_width_npix)
waveguide_bottom_output2 = int(center_y - waveguide_width_npix - waveguide_halfwidth_npix)
...
padding[-min_feature_size:,waveguide_bottom_output1 + min_feature_size:waveguide_top_output1 + min_feature_size] = 1
padding[-min_feature_size:,waveguide_bottom_output2 + min_feature_size:waveguide_top_output2 + min_feature_size] = 1
...
t_low_fidelity = 14.5 # low-fidelity simulation time in seconds
t_high_fidelity = 112.1 # high-fidelity simulation time in seconds
...
if optimization_algorithm == 'TF_BFGS':
    ...
    output_filename = 'WDM_diplexer_Ntrial' + str(Ntrial) + '_Ndim' + str(Nx) + 'x' + str(Ny) + '_D' + str(symmetry) \
    ...
    output_filename = 'WDM_diplexer_sigmaRBF4_Nensemble' + str(Nensemble) + '_Ndim' + str(Nx) + 'x' + str(Ny) + '_D' + str(symmetry) \
    ...
    output_filename = 'WDM_diplexer_Nensemble' + str(Nensemble) + '_Ndim' + str(Nx) + 'x' + str(Ny) + '_D' + str(symmetry) \
        + '_mfs' + str(min_feature_size) + '_try' + str(n_seed+1)
