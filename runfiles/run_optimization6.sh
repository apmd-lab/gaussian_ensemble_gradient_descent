...
for i in {0..9}
do
    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 12 --n_seed $i --load_data 0 --optimizer 'GEGD' --Nx 75 --Ny 75 --symmetry 0 --upsample_ratio 1 --coeff_exp 20 --maxiter 200 --sigma_ensemble_max 1.2e-10 --eta 1.2e-12 --min_feature_size 5 --zoom_factor 0.71
done
