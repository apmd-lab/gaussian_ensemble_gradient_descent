...
##for i in {0..9}
##do
##    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 12 --n_seed $i --load_data 0 --optimizer 'TF_BFGS' --symmetry 4 --upsample_ratio 1 --maxiter 500 --brush_size 7
##done
...
##for i in {0..9}
##do
##    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 32 --n_seed $i --load_data 0 --optimizer 'GEGD' --symmetry 4 --upsample_ratio 1 --coeff_exp 20 --maxiter 500 --sigma_ensemble_max 2e-3 --eta 2e-5 --brush_size 7
##done

## AF_PSO
for i in {0..9}
do
    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 16 --n_seed $i --load_data 0 --optimizer 'AF_PSO' --symmetry 1 --upsample_ratio 1 --maxiter 200 --min_feature_size 7
done
...
##for i in {0..4}
##do
##    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 12 --n_seed $i --load_data 0 --optimizer 'AF_CMA_ES' --symmetry 4 --upsample_ratio 1 --maxiter 500 --brush_size 7
##done

## AF_BL
##for i in {0..9}
##do
##    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 12 --n_seed $i --load_data 0 --optimizer 'AF_BL' --symmetry 4 --upsample_ratio 1 --maxiter 500 --eta 0.001 --brush_size 7
##done
