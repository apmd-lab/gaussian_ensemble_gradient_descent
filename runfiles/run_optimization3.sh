...
for i in {0..9}
do
    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 16 --n_seed $i --load_data 0 --optimizer 'TF_BFGS' --symmetry 0 --upsample_ratio 1 --maxiter 200 --min_feature_size 7
done
