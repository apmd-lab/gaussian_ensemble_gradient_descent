...
for i in {0..9}
do
    python /home/minseokhwan/gaussian_ensemble_gradient_descent/runfiles/run_optimization_test_functions.py --Nthreads 12 --n_seed $i --load_data 0 --optimizer 'AF_CMA_ES' --Nx 100 --Ny 100 --symmetry 4 --upsample_ratio 1 --maxiter 200 --min_feature_size 7 --zoom_factor 1.0
done
